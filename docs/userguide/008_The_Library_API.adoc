...
to older code bases, etc. Java 8 projects, or environments where the JPMS is for some
...
We can then derive a general "self-growing" rule using the following API:
